...
public final class Field {
    ...
    public static void drawGameOver(Terminal.Color terminalColor){
       // for (int i = 5; i < 9; i++) {
            screen.putString(50, 4,SCORE, Terminal.Color.MAGENTA, terminalColor);
            screen.putString(51, 9,SCORE, Terminal.Color.MAGENTA, terminalColor);
       // }

       // for (int j = 4; j < 10; j++) {
            screen.putString(5, 13,SCORE, Terminal.Color.MAGENTA, terminalColor);
      //  }
